...
ind_liv_age_plot <- ggplot(b18107_data,
  ...
  scale_fill_pha() +
  labs(title = "Net change in individuals with<br>independent living difficulties by age",
...
vets_plot <- ggplot(b21100_data,
  ...
  scale_y_continuous(labels = label_comma()) +
  scale_fill_pha() +
  labs(title = "Net change in veterans with<br>service-connected disability by disability rating",
       subtitle = "2016 to 2020",
