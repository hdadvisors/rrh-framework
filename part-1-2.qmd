...
hh_form_plot <- ggplot(b25003_data,
       aes(x = year,
           y = run_diff,
           fill = tenure,
           data_id = run_diff,
...
hh_age_plot <- ggplot(b25007_data,
       aes(y = change,
           x = tenure,
           fill = tenure,
           data_id = change,
  ...
  facet_wrap(~age, nrow = 1, labeller = labeller(age = label_wrap_gen(width = 12))) +
  scale_y_continuous(labels = label_comma(),
...
hh_type_plot <- ggplot(b11001_data,
...
hh_size_plot <- ggplot(b25009_data,
       aes(x = tenure,
           y = change,
           fill = tenure,
           data_id = change,
  ...
  geom_col(position = "dodge") + 
  geom_col_interactive(position = "dodge", size = 2) +
  facet_wrap(~size, nrow = 1, labeller = labeller(size = label_wrap_gen(width = 12))) +
  scale_y_continuous(labels = label_comma(),
...
hh_child_plot <- ggplot(b25115_data,
       aes(x = children,
           y = change,
           fill = tenure,
           data_id = change,
...
hh_seniors_plot <- ggplot(b09020_data,
...
hh_subfam_plot <- ggplot(b11013_data,
       aes(x = year,
           y = estimate,
           fill = children,
           data_id = estimate,
...
hh_multigen_plot <- ggplot(multigen_data,
       aes(x = YEAR,
           y = pct,
           color = geography,
           group = 1)) +
...
hh_adultchild_plot <- ggplot(b09021_data,
...
if (knitr::is_html_output()) {
  ...
  girafe(ggobj = hh_adultchild_plot,
         height_svg = 4)
