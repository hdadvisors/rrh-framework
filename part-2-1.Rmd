...
The stock of homeowner housing has been growing across the region. From 2016 to 2020, owner-occupied housing has increased by 17,436 --- an increase of seven percent. Undoubtedly, much of that growth (93 percent) has occurred in the single-family home market, including detached and attached homes. The largest share of that single-family home growth has occurred in Chesterfield County, where there was a net gain of 7,184 single-family homeowners.
```{r oo-structure}
...
structure_bar <- ggplot(oo_structure,
  ...
  facet_wrap(~county) + 
  labs(title = "Change in homeowner housing by structure type", subtitle = "From 2016 to 2020") +
...
The supply of for-smale housing across the region has changed very
...
ggplot(pha_homeownership,
       aes(x = year, y = ho_rate, colour = county)) +
  geom_line(stat = "identity")
