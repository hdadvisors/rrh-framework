...
pha_pop <- list_counties("VA", year = 2021) |>
...
pep_comp_change <- pep_change_clean |> 
  rbind(pep_2021)

write_rds(pep_comp_change, "data/pep_comp_change.rds")

```

```{r components-plot}

pep_comp_change <- read_rds("data/pep_comp_change.rds")

comp_chg_summary <- pep_comp_change |> 
