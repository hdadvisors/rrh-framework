# (PART) PART 1: Demographic and socioeconomic changes {.unnumbered}
...
```{r total-pop-plot, fig.cap="Percent change in population by locality"}
...
```{r components-plot, fig.cap="Components of population change"}
...
```{r forecasts-region-plot, fig.cap="Population projections"}
...
```{r forecasts-locality-plot, fig.cap="Population projections by locality"}
