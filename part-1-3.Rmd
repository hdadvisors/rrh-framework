...
b25118_data <- b25118_raw |> 
  ...
  group_by(year, NAME, tenure, income) |> 
  summarise(estimate = sum(estimate)) |> 
  select(year, NAME, tenure, income, estimate) |> 
...
ggplot(b25118_pha, 
  ...
  labs(title = "Income distribution by tenure: 2016 to 2020")
...
b25119_cpi <- b25119_data |> 
  ...
  select(year, locality, tenure, dollars20, cdollars)

# Wrote rds based on the entire region to use for local summaries

write_rds(b25119_cpi, "data/b25119_cpi_rr.rds")
