...
cb_inc_plot <- ggplot(cb_income,
  ...
  scale_y_continuous(labels = label_comma()) +
  labs(title = "Cumulative change in cost-burdened households<br>by income and tenure",
       subtitle = "2015 to 2019",
       fill = "Tenure",
       caption = "**Source:** U.S Department of Housing and Urban Development,<br>Comprehensive Housing Affordability Strategy (CHAS), Table 7.") +
  theme(legend.position = "right",
...
acs_yoy_plot <- ggplot(b25074_yoy,
       aes(x = year, 
           y = yoy,
           data_id = yoy,
           tooltip = label_comma()(yoy))) +
...
mortd_plot <- ggplot(mort_del,
  ...
  geom_point_interactive(
    aes(data_id = estimate,
        tooltip = label_percent()(estimate)),
    size = 0.5) + 
  theme_pha() +
  scale_color_pha() + 
...
eviction_colors <- setNames(c("#a6cccc", "#be451c"),
...
evict_plot <- ggplot(evictions,
  ...
  scale_y_continuous(labels = label_comma(), expand = expansion(mult = 0)) +
...
evict_avg_plot <- ggplot(eviction_avg,
       aes(x = year,
           ...
           fill = type,
           data_id = avg,
           tooltip = label_comma(accuracy = 1)(avg))) +
  geom_col(position = "dodge") +
  geom_col_interactive(position = "dodge", size = 2) +
  facet_wrap(~Jurisdiction) +
  theme_pha() +
  ...
  scale_y_continuous(labels = label_comma()) +
  scale_fill_manual(values = eviction_colors) +
  scale_x_discrete(limits = 2017 + 0:5) +
  theme(legend.position = "bottom") +
  add_zero_line(axis = "y")
...
The majority of calls were for rental options (36 percent) and financial assistance (21 percent). The two other largest share of calls were for an option not listed (17 percent) and homelessness (12 percent).
...
pit_plot <- ggplot(rva_pit,
  ...
  labs(title = "Greater Richmond Continuum-of-Care Point-in-Time count",
       ...
       caption = "**Sources:** U.S. Department of Housing and Urban Development, CoC Homeless Populations and<br>Subpopulations Reports; Homeward 2022 Winter PIT Count Preliminary Data.") +
  scale_y_continuous(labels = label_comma()) +
  add_zero_line(axis = "y")
...
mkv_plot <- ggplot(mkv,
  ...
  labs(title = "Enrolled students experiencing homelessness by school year",
       ...
       caption = "**Source:** William & Mary School of Education, Project HOPE - Virginia.") +
  scale_y_continuous(labels = label_comma()) +
  add_zero_line(axis = "y")
