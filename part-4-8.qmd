...
Adults under 75 with independent living difficulties have increased across the county since 2016, but decreased for those 75 and over. This is likely the result of the county's elderly population naturally declining, while "younger" seniors and adults making up most new household growth.
...
```{r}
#| label: fig-renters
#| fig-cap: "New Kent County: Percent of renter households"
...
renter_plot <- ggplot(b25003_data,
  ...
  labs(title = "New Kent County: Percent of renter households", 
