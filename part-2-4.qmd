...
if (knitr::is_html_output()) {
  ...
  ggplot() +
    ...
    scale_color_continuous(type = "viridis", labels = label_dollar()) +
    labs(title = "Map of NOAH properties in region",
...
ggplot(noah_cnt,
  ...
  scale_color_manual(values = c("#a6cccc", "#5bab8e", "#f39152", "#be451c")) +
  scale_fill_manual(values = c("#a6cccc", "#5bab8e", "#f39152", "#be451c")) +
...
if (knitr::is_html_output()) {
  ...
  ggplot() +
    rr_basemap +
    geom_sf(noah_dropna_style, mapping = aes(color = style), show.legend = "point") +
    labs(title = "Map of NOAH properties by building style",
...
```{r}
#| label: fig-mhc-map
#| fig.cap: "Map of manufactured housing communities"
...
if (knitr::is_html_output()) {
  ...
  ggplot() +
    ...
    labs(title = "Map of manufactured housing communities",
         color = "Units in park",
         caption = "Source: Manufactured Home Community Coalition of Virginia.") +
    #fixed_plot_aspect(ratio = 0.8) +
    theme(panel.background = element_blank(),
