...
write_rds(population_data, "data/population_data.rds")
...
write_rds(b25007_ashland, "data/b25007_ashland.rds")
...
b25007_ashland <- read_rds("data/b25007_ashland.rds")

age_plot <- ggplot(b25007_ashland,
       aes(y = change, 
           x =tenure, 
           fill = tenure,
           data_id = change,
  ...
  scale_fill_pha() +
  scale_y_continuous(labels = label_comma()) +
  labs(title="Town of Ashland: Change in households by age and tenure",
...
write_rds(b25115_ashland, "data/b25115_ashland.rds")
...
b25115_ashland <- read_rds("data/b25115_ashland.rds")

ch_plot <- ggplot(b25115_ashland,
       aes(x = tenure, 
           y = change, 
           fill = tenure,
           data_id = change,
  ...
  labs(title = "Town of Ashland: Change in households<br>with children by tenure",
       subtitle = "2016 to 2020",
...
write_rds(b09020_ashland, "data/b09020_ashland.rds")
...
b09020_ashland <- read_rds("data/b09020_ashland.rds")

snr_plot <- ggplot(b09020_ashland,
  ...
  labs(title = "Town of Ashland: Change in senior population<br>by living arrangement",
       subtitle="2016 to 2020",
       fill="Tenure",
...
write_rds(b25119_ashland, "data/b25119_ashland.rds")
...
b25119_ashland <- read_rds("data/b25119_ashland.rds")

inc_plot <- ggplot(b25119_ashland, 
       aes(x = year,
           y = dollars20,
           fill = tenure,
           data_id = dollars20,
...
rent_plot <- ggplot(rent,
  ...
  theme_pha() +
  scale_color_pha() +
  labs(title = "Town of Ashland: Average asking rent",
...
slgap <- b25119_ashland %>% 
  ...
  pivot_longer(2:3,
               ...
               values_to = "dollars") |> 
  mutate(label = case_when(
    label == "cdollars" ~ "Renter median household income",
...
```{r}
#| label: fig-ash-cb
#| fig-cap: "Town of Ashland: Cost burdened households by tenure"
...
cb_plot <- ggplot(ashland_cb_cln,
  ...
  scale_fill_pha() +
  facet_wrap(~tenure) +
  labs(title = "Town of Ashland: Cost burdened households by tenure",
       subtitle = "2015 and 2019",
       fill = "Cost burden") +
