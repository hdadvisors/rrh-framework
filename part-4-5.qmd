...
```{r}
#| label: fig-sales
#| fig-cap: paste0(name, ": Median home sales price (adjusted for inflation")
...
#| fig-cap: paste0(name, ": Income needed to afford median home price\nversus median renter income")
...
From 2015 to 2018, there has been little change in the percent of households experiencing cost burden. Although there has been a slight decline in the number of cost-burdened homeowners, the share of cost-burdened homeowners has remained largely unchanged (24 percent in 2018). For renters, the number of cost-burdened renters has remained unchanged (180).

```{r cb, fig.cap=paste0(name, ": Cost-burdened households by tenure")}
