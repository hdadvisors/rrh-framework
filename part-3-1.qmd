...
jobs_plot <- occ_locality_afford |> 
  ...
  scale_fill_pha() +
  scale_y_continuous(labels = label_dollar()) +
  labs(title = "Median annual salaries for the<br>five most common occupation categories",
...
job_rent <- ggplot(occ_locality_afford,
  ...
  labs(title = "Most workers cannot afford rent on their own",
       ...
       caption = "**Sources:** U.S. Bureau of Labor Statistics, Occupational Employment and Wage Statistics;<br>CoStar Group, Inc.") +
  theme_pha() +
