...
cost_plot <- ggplot(costs_income_change,
 ...
 geom_point_interactive(
    aes(data_id = pct_chg,
        tooltip = percent_format()(pct_chg)),
    size = 0.5) + 
  theme_pha() +
  scale_color_pha() + 
  ...
  labs(title = "Cumulative percent change in median renter income,<br>home prices, and average rent",
       ...
       caption = "**Sources:** U.S. Census Bureau, American Community Survey, Table B25119,<br>Central Virginia MLS, and CoStar Group, Inc.") +
  theme(legend.position = "bottom")
...
rent_gap <- ggplot(rent_afford,
  ...
  labs(title = "Average rents versus affordable rents for median renter income",
       subtitle ="2016 to 2022 (ACS income data through 2020)",
       caption = "Sources: U.S. Census Bureau, American Community Survey,<br>Table B25119 and CoStar Group, Inc.") +
  theme(legend.position = "bottom",
...
job_rent <- ggplot(aes(x = reorder(group, rent, decreasing = T),
           y = rent,
           fill = group)) +
  geom_col() +
  geom_col_interactive(size = 2) +
  ...
  labs(title = "Affordable rent by median occupation wage versus average rents",
       ...
       caption = "**Sources:** U.S. Bureau of Labor Statistics, Occupational Employment and<br>Wage Statistics; CoStar Group, Inc.") +
...
ggplot(aes(x = reorder(group, price, decreasing = T),
  ...
  labs(title = "Maximum home price by median occupation wage versus median sales prices",
       ...
       caption = "**Sources:** U.S. Bureau of Labor Statistics, Occupational Employment and <br>Wage Statistics; CVR MLS.") +
  theme(panel.background = element_blank(),
        legend.position = "none",
        axis.title = element_blank(),
        axis.ticks = element_blank(),
