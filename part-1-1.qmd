...
total_pop_widget <- girafe(ggobj = total_pop_plot,
                           height_svg = 4)
...
# Export widget via htmlwidgets

htmlwidgets::saveWidget(total_pop_widget, "widgets/htmlwidgets/total_pop.html", selfcontained = TRUE)

# Export widget via htmltools

htmltools::save_html(total_pop_widget, "widgets/htmltools/total_pop.html")
