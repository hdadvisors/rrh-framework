...
```{r hh-form-plot, fig.cap="Cumulative change in households by tenure"}
...
```{r hh-age-plot, fig.cap="Change in households by age and tenure"}
...
```{r hh-type-plot, fig.cap="Change in household type"}
...
```{r hh-size-plot, fig.cap="Change in household size by tenure"}
...
```{r hh-child-plot, fig.cap="Change in households with children by tenure"}
...
```{r hh-seniors-plot, fig.cap="Change in senior population by living arrangement"}
...
```{r hh-subfam-plot, fig.cap="Subfamilies by type and presence of own children"}
...
```{r hh-multigen-plot, fig.cap="Percent of population living in multiple generation households"}
...
```{r hh-adultchild-data, eval=FALSE}
...
```{r hh-adultchild-plot, fig.cap="Change in 18-34 year old population by living arrangement"}
