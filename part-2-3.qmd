...
chg_plot <- ggplot(change_region,
       aes(x = reorder(subsidy_name, units),
           ...
           fill = subsidy_name,
           color = subsidy_name,
           label = label_number(big.mark = ",", style_positive = "plus", style_negative = "minus")(units))) +
  geom_col() +
  theme_pha() +
  scale_fill_pha() +
  scale_color_pha() +
...
lchg_plot <- ggplot(change_locality,
       aes(x = reorder(subsidy_name, units),
           ...
           color = subsidy_name,
           data_id = units,
           tooltip = label_number(big.mark = ",", style_positive = "plus", style_negative = "minus")(units))) +
  geom_col() + 
